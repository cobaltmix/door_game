...
def select_class(
    ...
    print(
        "READ BEFORE PLAYING GAME: To progress through scenarios, press enter or type in the answer to the prompt given."
    )
...
def start_game(
    ...
    print(
        "There are three doors in front of you. One is red, one is blue, and one is green."
    )
...
def red_room(
    ...
    if rand_seed == 0:
        ...
        while True:
            ...
            if choice == "take shard":
                ...
                health = health - 8
                input(
                    "As you take the magical shard, a ghostly voice whispers, 'You must find all 5 shards and return to the green room in order to escape this dungeon'."
                )
                shards += 1
                start_game(
                    health,
    ...
    if rand_seed == 1:
        print(
            "Your skin fills with goosebumps as you enter the room, full of carcasses and human skulls."
        )
        print(
            "A goblin, ears perked, hears the sound of you entering and looks directly at you."
        )
        ...
        while True:
            ...
            if choice == "attack":
                ...
                input(
                    "The goblin throws a dagger as you leave the room, grazing your chest."
                )
...
def blue_room(
    ...
    if rand_seed == 1:
        input(
            "As you enter the room, you see the room is flooded, teeming with crocodiles. ."
        )
    ...
    if rand_seed == 2:
        print(
            "'Welcome,' a phantomly voice whispers, 'This is the coin flip. If it lands on heads, you lose 8 health, if it lands on tails, you will gain a shard. Are you up for the task?"
        )
        while True:
...
def green_room(
    ...
    input(
        f"'So you have passed all of my tests, I guess I must let you out at this time. Goodbye {class_selected}.'"
    )
    input(
        "As you leave the cursed dungeon, your memory becomes hazy, your eyes blurry, and your head dizzy."
    )
        ...
        while True:
            ...
            while True:
                ...
                if choice == "attack":
                    ...
                    input(
                        f"The skeleton, shooting with perfect precision, hits your shoulder!"
                    )
                    print(f"{skel_attack-defense} damage!")
...
def attack_drag(
    ...
    if class_selected == "warrior":
        while True:
            ...
            print(f"{strength-gob_defense} damage!")
            input(
                f"The dragonfly, buzzing around you, spits a venomous liquid at your chest!"
            )
            ...
            while True:
                ...
                if choice == "attack":
                    ...
                    input(
                        "The dragonfly flys towards you, just before you leave the room."
                    )
                    start_game(
                        health,
                        class_selected,
